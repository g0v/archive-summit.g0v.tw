schedule = do
  ...
  r2_am_topic:
    ...
    moderator: "<span class='text-primary speaker-info' data-toggle='modal' data-target='\#Info5'>劉致昕</span>"
    short_desc_zh: "民主如何參與、參與式民主如何實現，是近年越來越受重視的議題。g0v 社群成立之初便討論相關案例、 ..."
    short_desc_en: "How does one participate in democracy and how to make participatory democracy ..."
  r3_am_topic:
    title_zh: "3du"
    title_en: "3du"
    ...
    desc_en:
      0: "This MoeDict project stems from the Ministry of Education's revision of the Mandarin Dictionary. With assistance from a diverse set of contributors, it gradually integrated Taiwan's various languages and facilitated a multicultural dialogue in the spirit of open information."
      1: "We are honored to have enlisted the help of the Ministry of Education and the pioneers of Taiwanese languages digitization in the education sector and have them share with us the fruit of our success in recent years. The new design for Moedict's website and mobile app will be unveiled for the first time during the summit."
    moderator: "唐鳳"
    short_desc_zh: "從教育部重編國語詞典資料庫開始的萌典計畫，在各界人士的襄助下，將臺灣的各種語文漸次整合，以 ..."
    short_desc_en: "This MoeDict project stems from the Ministry of Education's revision of the ..."
  r4_am_topic:
    title_zh: "公民新科技"
  ...
  r1_1020:
    ...
    speaker_en: "Matthew Rumsey"
    tag_zh: "Sunlight Foundation/美"
    tag_en: "Sunlight Foundation/US"
    language: "EN"
    interpretation: "ZH"
  r2_1020:
    speakerId: 31
  ...
  r1_pm_topic:
    ...
    language: "ZH"
    moderator: "<span class='text-primary speaker-info' data-toggle='modal' data-target='\#Info9'>蕭新煌</span>"
    short_desc_zh: "太陽花學運中，媒體的作用與以往運動有了一些轉變。主流媒體與新媒體之間的交互作用，從電視、報紙雜誌、 ..."
    short_desc_en: "The functions of the media have changed some of the past campaign practices of the ..."
  r2_pm_topic:
    title_zh: "開放資料與環境"
    ...
    moderator: "<span class='text-primary speaker-info' data-toggle='modal' data-target='\#Info26'>鄧東波</span>"
    short_desc_zh: "現今的氣候變遷，以及環境的過度利用，導致天災頻傳，而由 g0v 過往製做的雨量熱度圖、空氣污染圖 ..."
    short_desc_en: "Presently, climate change and the overuse of environmental resources ..."
  r3_pm_topic:
    title_zh: "大協作世代"
